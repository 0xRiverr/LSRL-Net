...
def get_h5_files(directory, case_start, case_end):
    h5_files = []
...
class Promise12(Dataset):
    ...
    def __init__(self, data_dir, mode, out_size):
        self.h5_files = get_h5_files('/home/prejudice/datasets/promise12_levelset/png2h5', 0, 34)
    ...
    def __getitem__(self, i):
        ...
        mask_levelset = 0
        if self.mode == 'train':
            # case = get_h5_files('/home/prejudice/datasets/promise12_levelset/png2h5', 0, 34)
            # h5f_levelset = h5py.File('/home/prejudice/datasets/promise12_levelset/png2h5/{}'.format(case[i]), "r")
            # mask_levelset = h5f_levelset["mask_levelset"][:]
            # 根据索引 i 获取对应的 h5 文件
            case_file = self.h5_files[i % len(self.h5_files)]
