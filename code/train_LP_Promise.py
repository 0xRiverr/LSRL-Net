...
parser.add_argument('--exp', type=str,
                    default='Promise12/Lab_Propagation_Prostate_2_0913_211', help='experiment_name')
...
parser.add_argument('--seed', type=int, default=211, help='random seed')
...
# promise12：{"2": 47, "4": 111, "7": 191, "11": 306, "14": 391, "18": 478, "35": 940}
# ACDC：{"1": 34, "3": 68, "7": 136, "14": 256, "21": 396, "28": 512, "35": 664, "140": 1312}
parser.add_argument('--labeled_num', type=int, default=2,
                    help='labeled data')
parser.add_argument('--final_labeled_num', type=int, default=4,
                    help='labeled data')
...
def get_max_and_else(outputs_soft1):
    ...
    mask1 = F.one_hot(predicted_classes1, num_classes=2).permute(0, 3, 1, 2).float()
