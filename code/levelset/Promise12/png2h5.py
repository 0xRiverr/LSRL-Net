...
# 定义输入和输出文件夹路径
input_folder = '/home/prejudice/datasets/promise12_levelset/png2bin/binarize'
output_folder = '/home/prejudice/datasets/promise12_levelset/png2h5'
...
for filename in os.listdir(input_folder):
    if filename.endswith('.png'):
        ...
        start_x = (256 - 256) // 2
        start_y = (256 - 256) // 2
        padded_data[start_y:start_y + 256, start_x:start_x + 256] = data
